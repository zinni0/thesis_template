...
<!-- ANPASSEN: Diese Datei ist eine Vorlage. Ersetze alle {{PLATZHALTER}}, arbeite die
     <!-- ANPASSEN -->-Hinweise ab und lösche danach diese Kommentare. -->

## What this repository is

This is **not a software project** — it is a working directory for {{KONTEXT, z. B. „a German university
seminar / Hausarbeit / Bachelorarbeit"}} on the topic **{{THEMA}}**. There is no code, build system, or
test suite. Work here is **research and academic writing**: {{DELIVERABLES, z. B. „a written seminar
paper"}}. Respond and write deliverables in **{{SPRACHE, z. B. German}}** unless asked otherwise.

The full project brief lives in `context.txt`. Read it before doing substantive work — the sections
below summarize it, but it is the source of truth and may be updated by the user.
...
- `Quellen.md` — zentrales Literaturverzeichnis ({{ZITIERSTIL, z. B. APA 7}}); jeder Beleg zeigt hierauf
...
Quelle als vollständigen {{ZITIERSTIL}}-Eintrag in `Quellen.md` ergänzen → nächsten ungeprüften Eintrag.
...
**3 — Schreiben.** Belegt, sachlich, **{{SPRACHE}}**, **{{ZITIERSTIL}}**. Jede inhaltliche Aussage bekommt
einen In-Text-Beleg (Autor, Jahr) mit Eintrag in `Quellen.md`. Unklares wandert nach `Offene-Punkte.md`,
...
- [ ] Jede inhaltliche Aussage hat einen {{ZITIERSTIL}}-Beleg mit Eintrag in `Quellen.md`.
...
- **{{SPRACHE}}-Commit-Message**, knapp im Imperativ (z. B. `Dossier: {{Beispiel}} belegt`).
- **Nicht pushen ohne ausdrückliche Anweisung.**

## Sonstige Conventions

- Schreibsprache der Deliverables: **{{SPRACHE}}**. Belege/Quellen dürfen anderssprachig sein
  (Titel im Literaturverzeichnis in Originalsprache, {{ZITIERSTIL}}-konform).
